...
function JoinCard({ onToast }) {
  ...
  const handle = () => {
    if (!code.trim()) { onToast("Please enter a room code"); return; }
  ...
  return (
    <div className="bg-white rounded-3xl p-7 shadow-[0_4px_24px_rgba(0,0,0,0.07),0_1px_4px_rgba(0,0,0,0.04)]">
      <div className="flex items-center gap-3 mb-2">
        <div className="w-12 h-12 rounded-[14px] bg-orange-50 flex items-center justify-center flex-shrink-0"
          style={{ boxShadow: "0 4px 14px rgba(230,112,25,0.18)" }}>
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#E67019" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button
        ...
        style={{ background: "#fff3eb", color: "#E67019", boxShadow: "0 2px 8px rgba(230,112,25,0.12)" }}
      >
        Join room →
      </button>
    </div>
...
function CreateCard({ onToast }) {
  ...
  const handle = () => {
    if (!name.trim()) { onToast("Please enter a room name"); return; }
  ...
  return (
    <div className="bg-white rounded-3xl p-7 shadow-[0_4px_24px_rgba(0,0,0,0.07),0_1px_4px_rgba(0,0,0,0.04)]">
      <div className="flex items-center gap-3 mb-2">
        <div className="w-12 h-12 rounded-[14px] bg-orange-500 flex items-center justify-center flex-shrink-0"
        ...
        <span className="text-[17px] font-bold text-gray-900">Create a room</span>
      </div>
      <p className="text-[13px] text-gray-400 leading-relaxed mb-4">
      ...
      <button
        ...
        style={{ background: "#E67019", boxShadow: "0 4px 16px rgba(230,112,25,0.38)" }}
      >
        Create room →
      </button>
    </div>
    ...
    <div className="min-h-screen bg-[#f0f0f7] px-7 py-8 font-sans">
      <div className="mb-8">
        <h1 className="text-[30px] font-extrabold text-gray-900 leading-tight">
          {timeGreet}, <span className="text-orange-500">Mukie</span> 👋
        </h1>
